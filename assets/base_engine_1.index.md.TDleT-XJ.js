...
</code></pre><div class="tip custom-block"><p class="custom-block-title">总结</p><p>通过以上对 vue 项目开发的流程，我们可以大概了解到实际开发中所进行的环节，以及相关环节下需要做的事情，对全面理解 vue 的前端开发做好铺垫。</p></div>`,72),c=[n];function s(l,p,i,h,u,b){return a(),e("div",null,c)}const _=t(d,[["render",s]]);export{k as __pageData,_ as default};
